...
export default function AdminHeader() {
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
        ...
        <div
          id="tooltip-default"
          role="tooltip"
          class="inline-block absolute invisible z-30 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip dark:bg-gray-600"
        >
