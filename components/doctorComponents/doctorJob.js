...
export default function DoctorJob(props) {
  return (
    <div class="w-7/12 rounded-lg border border-slate-300 shadow-md h-fit m-2 mt-4 ml-0 pl-0">
        ...
        <div class="flex flex-col flex-nowrap md:flex-row items-center border-t-2 p-3 justify-center">
