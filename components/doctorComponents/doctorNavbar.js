      ...
      <nav class=" bg-gradient-to-b from-sky-200 border-gray-200 md:px-5 border-4 sm:px-3 rounded-b-3xl dark:bg-gray-800 top=0">
        ...
        <Link href='/' >
          ...
          <div class="flex md:order-2">
            ...
            <button
              type="button"
              class="text-red-700 hover:text-white border border-red-500 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2 text-center mr-2 mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-600 dark:focus:ring-blue-800"
            >
              Log Out
            </button>
            <button 
